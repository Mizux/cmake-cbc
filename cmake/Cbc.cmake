...
foreach (COIN_PROJECT CoinUtils Osi Clp Cgl Cbc)
	...
	message(STATUS "${COIN_PROJECT} version: ${${COIN_PROJECT}_VERSION}")
	set_target_properties(${COIN_PROJECT} PROPERTIES
		IMPORTED_LOCATION	${install_dir}/lib/${CMAKE_FIND_LIBRARY_PREFIXES}${COIN_PROJECT}.a
		INTERFACE_INCLUDE_DIRECTORIES	"${install_dir}/include;${install_dir}/include/coin"
		VERSION ${${COIN_PROJECT}_VERSION})
	...
	if (${COIN_PROJECT} STREQUAL "Cbc" OR ${COIN_PROJECT} STREQUAL "Clp")
		...
		set_target_properties(Osi${COIN_PROJECT} PROPERTIES
			IMPORTED_LOCATION	${install_dir}/lib/libOsi${COIN_PROJECT}.a
			INTERFACE_INCLUDE_DIRECTORIES	"${install_dir}/include;${install_dir}/include/coin"
			VERSION ${${COIN_PROJECT}_VERSION})
		# Can't Alias imported target.
		...
		set_target_properties(${COIN_PROJECT}Solver PROPERTIES
			IMPORTED_LOCATION	${install_dir}/lib/lib${COIN_PROJECT}Solver.a
			INTERFACE_INCLUDE_DIRECTORIES	"${install_dir}/include;${install_dir}/include/coin"
			VERSION ${${COIN_PROJECT}_VERSION})
		# Can't Alias imported target.
